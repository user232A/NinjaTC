...
public class ModelComparator {
  ...
  private static Object getFieldValue(Object obj, String fieldName) {
    ...
    if (fieldName.contains(".")) {
      String currentPart = fieldName.substring(0, fieldName.indexOf("."));
      String remainingPath = fieldName.substring(fieldName.indexOf(".") + 1);
      Object nestedObject = getFieldValue(obj, currentPart);
      return getFieldValue(nestedObject, remainingPath);
    }
